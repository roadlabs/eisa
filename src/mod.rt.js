...
var module = NECESSARIA_module = function(){
	var global = this;
	var hash = function(){
		var n = 0;
		return function(){
	...
	var declare_ = function(name, dependents, factory){
  ...
  //----------------------------------------------------------------------------
	...
	return {
		...
		provide: provide, 
		declare_: declare_,
		declare: function(name, dependents, factory){
			if(typeof dependents === "function"){
				factory = dependents;
				dependents = []
			};
			factory = function(f){ return function(r, e, d){ d(f(r, e)) } }(factory)
			return declare_.call(this, name, dependents, factory);
		}
	}
}();
